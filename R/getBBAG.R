#' getBBAG - Download historic sale data from BBAG.
#'
#' \code{getBBAG} downloads historic sale data from the BBAG website in xls
#' format.
#'
#' \code{getBBAG} downloads historic sale data from the Baden-Badener
...
#' for BBAG sales have been tested as far back as 2009. The \link{scripts}
#' folder contains a complete set of URLs and function calls to generate data
#' for all sales back to 2009.
#'
...
#' csv = FALSE, rds = TRUE, sqlite = FALSE, auctioneer = "BBAG", country = "DE",
#' currency = "EUR", date = "2015-10-16", sale = "October Mixed Sales", filename
#' = "bbagSaleData")
#'
