#' getArqana - Download historic sale data from Arqana.
#'
#' \code{getArqana} downloads historic sale data from the Arqana website in xls
#' format.
#'
#' \code{getArqana} downloads historic sale data from the Arqana
...
#' Valid output formats are \code{csv}, \code{rds} and \code{sqlite}. Only a csv
#' is generated by default. Valid URLs for Arqana sales have been tested as far
#' back as 2009. The \link{scripts} folder contains a complete set of URLs and
#' function calls to generate data for all sales back to 2009.
#'
...
#' currency = "EUR", date = "2015-12-05", sale = "Breeding Stock Sale", filename
#' = "arqanaSaleData")
#'
