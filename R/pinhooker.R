#' pinhooker: Global Thoroughbred Bloodstock Sales Data.
#'
...
#' \code{getArqana}: download historic sales data for Arqana \url{http://arqana.com}.
#' \code{getBBAG}: download historic sales data for Baden-Badener Auktionsgesellschaft \url{http://bbag-sales.de}
#' \code{getTatts}: download historic sales data for Tattersalls \url{http://tattersalles.com} and Tattersalls Ireland \url{http://tattersalls.ie}
#'
