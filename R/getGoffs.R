#' getGoffs - Download historic sale data from Goffs and Goffs DBS.
#'
#' \code{getGoffs} downloads historic sale data from the Goffs and Goffs DBS
#' website in xls format.
#'
#' \code{getGoffs} downloads historic sale data from the Goffs
#' \url{http://goffs.com} and Goffs DBS \url{http://goffsdbs.com} websites, in
#' xls format, based on the supplied URL. Various options may be specified such
#' as a \code{filename} and output format. Valid output formats are \code{csv},
#' \code{rds} and \code{sqlite}. Only a csv is generated by default. Valid URLs
#' for Goffs and Goffs DBS sales have been tested as far back as 2009. The
...
#'
#' @example getGoffs(url =
#' "http://goffs.com/sales-results/sales/february-sale-2015/excel/", catalogue =
#' "http://goffs.com/files/9014/2107/7132/Full_catalogue.pdf", csv = FALSE, rds
#' = TRUE, sqlite = FALSE, auctioneer = "Goffs", country = "IRE", currency =
#' "EUR", date = "2015-02-11", filename = "goffsSaleData")
#'

getGoffs <-
  function(url, catalogue = "", auctioneer, country, currency, date, csv = TRUE, rds = TRUE, sqlite = TRUE, filename = "bloodstockSalesData") {
