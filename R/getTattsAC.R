#' getTattsAC - Download historic sale results data from Tattersalls and
#' Tattersalls Ireland.
#'
#' \code{getTattsAC} downloads historic sale results data from the Tattersalls and
#' Tattersalls Ireland websites.
#'
#' \code{getTattsAC} downloads historic sale data from the Tattersalls
